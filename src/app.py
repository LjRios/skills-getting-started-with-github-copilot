...
activities = {
    ...
    "Basketball Team": {
        ...
        "max_participants": 18,
        "participants": ["jason@mergington.edu", "maria@mergington.edu"]
    },
    "Swim Club": {
    ...
    "Art Workshop": {
        ...
        "max_participants": 20,
        "participants": ["lily@mergington.edu", "arjun@mergington.edu"]
    },
    "Drama Club": {
    ...
    "Science Club": {
        "description": "Engage in experiments and science research projects",
